...
import styles from '@/components/common/modal/Share.module.css';
import kakaoUrl from '@/public/assets/kakao.svg';
import facebookUrl from '@/public/assets/facebook.svg';
import linkUrl from '@/public/assets/link.svg';

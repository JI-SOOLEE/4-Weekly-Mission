...
const Button = styled.button`
  ...
  &::after {
    ...
    width: 1.6rem;
    height: 1.6rem;
    background: url('/assets/add.svg') no-repeat center bottom/contain;
  }
  ...
  @media (max-width: 767px) {
    ...
    &::after {
      background: url('/assets/add-white.png') no-repeat center bottom/contain;
    }
  }
`;
...
const FolderListArea = ({
  ...
  return (
    <FolderGroup>
      ...
      {showModal &&
        createPortal(
          <AddFolder onCloseModal={handleModalClose} />,
          document.body
        )}
    </FolderGroup>
  );
